...
class SimpleScreenplayApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        github_btn.clicked.connect(lambda: self.open_url("https://github.com/zancun/VisionAI-ClipsMaster"))
        ...
        # 添加版权信息
        copyright_label = QLabel("© 2025 zancun 版权所有")
