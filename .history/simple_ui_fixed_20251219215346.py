...
class SimpleScreenplayApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.cloud_platform_combo.setMinimumHeight(28)
        ...
        self.cloud_model_combo.setMinimumWidth(140)
        self.cloud_model_combo.setMinimumHeight(28)
        ...
        self.cloud_api_key_input.setMinimumWidth(220)
        self.cloud_api_key_input.setMinimumHeight(28)
        
        # 测试连接按钮
        self.test_cloud_btn = QPushButton("测试连接")
        self.test_cloud_btn.setMinimumWidth(80)
        self.test_cloud_btn.setMinimumHeight(28)
