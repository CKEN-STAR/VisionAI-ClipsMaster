...
class SimpleScreenplayApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        # 第二行：云端配置（云端模式时显示）- 平台、模型、API Key横向排列
        ...
        self.cloud_platform_combo.setMinimumWidth(110)
        ...
        self.cloud_model_combo.setMinimumWidth(120)
        ...
        self.cloud_api_key_input.setMinimumWidth(180)
        
        # 测试连接按钮
        self.test_cloud_btn = QPushButton("测试连接")
        self.test_cloud_btn.setMaximumWidth(80)
