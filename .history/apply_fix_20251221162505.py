...
# 定义新的_regenerate_timeline方法（使用原始字符串避免转义问题）
new_method = r'''    def _regenerate_timeline(self, all_viral_subtitles: List[Dict[str, Any]], language: str) -> List[Dict[str, Any]]:
