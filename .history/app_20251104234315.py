...
特点：
- 双模型架构：使用Qwen3系列处理中文内容，Mistral-7B处理英文内容
...
# from src.core.srt_parser import import_srt, export_srt  # removed: ScreenplayEngineer handles SRT I/O
...
class VisionAIClipsMaster:
    ...
    def __init__(self):
        ...
        # ScreenplayEngineer 当前构造函数不接受 use_low_memory 参数，保持兼容
    ...
    def process_video(self, video_path: str, subtitle_path: str, 
        ...
        try:
            ...
            # 生成混剪视频（质量检查开启）。如需画质/码率控制，后续接入 ClipGenerator 的画质预设接口
