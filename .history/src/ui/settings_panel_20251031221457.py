...
class SettingsPanel(QWidget if PYQT_AVAILABLE else object):
    ...
    def _refresh_model_list(self):
        ...
        try:
            ...
            # 定义需要扫描的目录模式（更新为Qwen3系列）
            scan_patterns = [
                ("qwen3-0.6b/base", "Qwen3-0.6B", "中文基础模型"),
                ("qwen3-0.6b/quantized", "Qwen3-0.6B", "中文量化模型"),
                ("qwen3-1.7b/base", "Qwen3-1.7B", "中文基础模型"),
                ("qwen3-1.7b/quantized", "Qwen3-1.7B", "中文量化模型"),
                ("qwen3-8b/base", "Qwen3-8B", "中文基础模型"),
                ("qwen3-8b/quantized", "Qwen3-8B", "中文量化模型"),
                ("qwen3-32b/base", "Qwen3-32B", "中文基础模型"),
                ("qwen3-32b/quantized", "Qwen3-32B", "中文量化模型"),
