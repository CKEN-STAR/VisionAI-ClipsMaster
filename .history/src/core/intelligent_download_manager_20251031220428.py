...
class IntelligentDownloadManager:
    ...
    def _initialize_model_configs(self):
        ...
        self.model_configs = {
            ...
            "qwen3-1.7b-zh": ModelDownloadConfig(
                model_name="qwen3-1.7b-zh",
                model_type="qwen",
                quantization="Q4_K_M",
                sources={
                    DownloadSourceType.MODELSCOPE: "https://modelscope.cn/models/qwen/Qwen3-1.7B-Instruct-GGUF/resolve/main/qwen3-1_7b-instruct-q4_k_m.gguf",
                    DownloadSourceType.HUGGINGFACE: "https://huggingface.co/Qwen/Qwen3-1.7B-Instruct-GGUF/resolve/main/qwen3-1_7b-instruct-q4_k_m.gguf",
                    DownloadSourceType.MIRROR: "https://hf-mirror.com/Qwen/Qwen3-1.7B-Instruct-GGUF/resolve/main/qwen3-1_7b-instruct-q4_k_m.gguf"
                },
                file_size=3_400_000_000
            )
        }
