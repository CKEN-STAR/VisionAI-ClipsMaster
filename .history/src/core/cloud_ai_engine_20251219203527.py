...
class CloudModel:
    """云端模型枚举"""
    QWEN3_235B = "qwen3-235b"         # Qwen3 235B-A22B 最大参数规模
    DEEPSEEK_V3 = "deepseek-v3"       # DeepSeek-V3.2 最新版
...
PLATFORM_CONFIG = {
    CloudPlatform.SILICONFLOW: {
        ...
        "models": {
            CloudModel.QWEN3_235B: "Qwen/Qwen3-235B-A22B",  # 硅基流动上的Qwen3最大模型
            CloudModel.DEEPSEEK_V3: "deepseek-ai/DeepSeek-V3",  # 硅基流动上的DeepSeek-V3模型
        },
        "headers_template": {
    ...
    CloudPlatform.DASHSCOPE: {
        ...
        "models": {
            CloudModel.QWEN3_235B: "qwen3-235b-a22b",  # DashScope上的Qwen3最大模型
            CloudModel.DEEPSEEK_V3: "qwen-max-latest",  # DashScope不直接支持DeepSeek，使用Qwen-Max替代
        },
        "headers_template": {
            "Content-Type": "application/json",
            "Authorization": "Bearer {api_key}"
...
def get_supported_models() -> List[Dict[str, str]]:
    """获取支持的模型列表"""
    return [
        {"id": CloudModel.QWEN3_235B, "name": "Qwen3-235B", "description": "阿里通义千问3 235B参数MoE大模型"},
        {"id": CloudModel.DEEPSEEK_V3, "name": "DeepSeek-V3", "description": "深度求索V3 671B参数MoE大模型"}
    ]
