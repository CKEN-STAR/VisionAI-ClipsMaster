...
class CloudModel:
    """云端模型枚举"""
    QWEN3_MAX = "qwen3-max"           # Qwen3最大参数规模
...
PLATFORM_CONFIG = {
    CloudPlatform.SILICONFLOW: {
        ...
        "models": {
            CloudModel.QWEN3_MAX: "Qwen/Qwen2.5-72B-Instruct",  # 硅基流动上的Qwen模型
            CloudModel.DEEPSEEK_V3: "deepseek-ai/DeepSeek-V3",  # 硅基流动上的DeepSeek模型
        },
        "headers_template": {
    ...
    CloudPlatform.DASHSCOPE: {
        ...
        "models": {
            CloudModel.QWEN3_MAX: "qwen-max",  # DashScope上的Qwen最大模型
            CloudModel.DEEPSEEK_V3: "deepseek-chat",  # DashScope上的DeepSeek模型（如果支持）
        },
        "headers_template": {
            "Content-Type": "application/json",
            "Authorization": "Bearer {api_key}"
