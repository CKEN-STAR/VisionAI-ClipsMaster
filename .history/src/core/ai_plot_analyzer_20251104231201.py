...
"""
                    ...
                    for attempt in range(1, max_attempts + 1):
                        response = llm.generate(p, temperature=0.25, max_length=200)
            ...
            max_attempts = 2
            for attempt in range(1, max_attempts + 1):
                response = llm.generate(prompt, temperature=0.25, max_length=200)
                if self._is_low_quality_text(response):
...
"""
                    ...
                    max_attempts = 2
                    for attempt in range(1, max_attempts + 1):
                        response = llm.generate(p, temperature=0.3, max_length=300)
                        if self._is_low_quality_text(response):
...
"""
                    ...
                    max_attempts = 2
                    for attempt in range(1, max_attempts + 1):
                        response = llm.generate(p, temperature=0.3, max_length=200)
                        if self._is_low_quality_text(response):
