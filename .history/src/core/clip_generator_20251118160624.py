            ...
            for i, item in enumerate(valid_segments):
                ...
                try:
                    ...
                    try:
                        ...
                        logger.info(f"[CutPlan] seg#{i:03d} {start_time:.3f}->{orig_end:.3f} -> {end_time:.3f} dur={final_duration:.3f} pad={univ_pad:.2f}{extra_tag} next={nxt_start:.3f} punct={ends_with_punct}")
                    except Exception:
                        pass
                except Exception:
                    pass
