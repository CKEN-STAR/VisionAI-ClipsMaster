...
class SimpleScreenplayApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.cloud_platform_combo.setMinimumWidth(130)
        self.cloud_platform_combo.setMinimumHeight(32)
        self.cloud_platform_combo.setStyleSheet("font-size: 13px; padding: 2px 5px;")
        self.cloud_platform_combo.currentIndexChanged.connect(self.on_cloud_platform_changed)
        
        # 模型选择
        self.cloud_model_combo = QComboBox()
        self.cloud_model_combo.addItem("Qwen3", "qwen3")
        self.cloud_model_combo.addItem("DeepSeek-V3.2", "deepseek-v3.2")
        self.cloud_model_combo.setMinimumWidth(145)
        self.cloud_model_combo.setMinimumHeight(32)
        self.cloud_model_combo.setStyleSheet("font-size: 13px; padding: 2px 5px;")
        ...
        self.cloud_api_key_input.setMinimumWidth(250)
        self.cloud_api_key_input.setMinimumHeight(32)
        self.cloud_api_key_input.setStyleSheet("font-size: 13px; padding: 4px 8px;")
        
        # 测试连接按钮
        self.test_cloud_btn = QPushButton("测试连接")
        self.test_cloud_btn.setMinimumWidth(90)
        self.test_cloud_btn.setMinimumHeight(32)
    ...
    def __init__(self, parent=None):
        ...
        <div style="margin: 15px; line-height: 1.6;">
            ...
            <div style="margin: 15px 0; padding: 12px; background-color: #fff3cd; border-left: 4px solid #ff6b35;">
                <h4 style="color: #2c3e50; margin-top: 0;">📅 2025年12月 - v1.2.0重大更新 🎉</h4>
            ...
            <div style="margin: 15px 0; padding: 12px; background-color: #fff3cd; border-left: 4px solid #ff6b35;">
                <h4 style="color: #2c3e50; margin-top: 0;">🎉 v1.2.0 重大更新</h4>
                <ul style="margin: 10px 0; padding-left: 20px;">
