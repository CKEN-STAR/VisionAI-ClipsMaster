...
class SimpleScreenplayApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.cloud_platform_combo.addItem("阿里云DashScope", "dashscope")
    ...
    def __init__(self, parent=None):
        ...
        <div style="margin: 15px; line-height: 1.6;">
            ...
            <div style="margin: 15px 0; padding: 12px; background-color: #e8f4fd; border-left: 4px solid #17a2b8;">
                <h4 style="color: #2c3e50; margin-top: 0;">🌐 阿里魔搭社区 (DashScope)</h4>
                <p><strong>Qwen3-235B：</strong>官方通义千问3大模型，支持思考模式切换</p>
                <p><strong>DeepSeek-V3：</strong>兼容DeepSeek系列模型API</p>
                <p><strong>API地址：</strong>https://dashscope.aliyuncs.com/compatible-mode/v1</p>
            </div>
    ...
    def __init__(self, parent=None):
        ...
        <div style="margin: 15px; line-height: 1.6;">
            ...
            <div style="margin: 15px 0; padding: 12px; background-color: #fff3cd; border-left: 4px solid #ff6b35;">
                ...
                <p><strong>🌐 双平台支持：</strong>集成硅基流动(SiliconFlow)和阿里魔搭社区(DashScope)两大平台</p>
            ...
            <div style="margin: 15px 0; padding: 12px; background-color: #fff3cd; border-left: 4px solid #ff6b35;">
                ...
                <ul style="margin: 10px 0; padding-left: 20px;">
                    ...
                    <li><strong>🌐 双平台支持：</strong>硅基流动(SiliconFlow) + 阿里魔搭社区(DashScope)</li>
